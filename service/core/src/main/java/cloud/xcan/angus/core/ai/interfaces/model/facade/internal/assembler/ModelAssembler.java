...
public class ModelAssembler {
   ...
   * 获取默认图标
   */
  private static String getDefaultIcon(cloud.xcan.angus.core.ai.domain.model.ModelType type) {
    switch (type) {
      case LANGUAGE:
        return "💬";
      case IMAGE:
   ...
   * 获取默认图标背景色
   */
  private static String getDefaultIconBg(cloud.xcan.angus.core.ai.domain.model.ModelProvider provider) {
    switch (provider) {
      case OPENAI:
        return "#10A37F";
      case ANTHROPIC:
   ...
   * 获取默认图标颜色
   */
  private static String getDefaultIconColor(cloud.xcan.angus.core.ai.domain.model.ModelProvider provider) {
    return "#FFFFFF";
  }
