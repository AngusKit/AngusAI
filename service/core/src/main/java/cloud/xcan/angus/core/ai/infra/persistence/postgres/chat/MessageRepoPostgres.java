...
public interface MessageRepoPostgres extends MessageRepo {
  ...
  @Override
  @Query(value = "SELECT (EXTRACT(HOUR FROM m.created_date)::int * 60 + EXTRACT(MINUTE FROM m.created_date)::int) AS minute_of_day, COUNT(*) "
  ...
  @Override
  @Query(value = "SELECT EXTRACT(MONTH FROM m.created_date)::int AS mth, COUNT(*) FROM ai_chat_message m "
  ...
  @Override
  @Query(value = "SELECT EXTRACT(DAY FROM m.created_date)::int AS d, COUNT(*) FROM ai_chat_message m "
  ...
  @Override
  @Query(value = "SELECT EXTRACT(HOUR FROM m.created_date)::int AS h, COUNT(*) FROM ai_chat_message m "
