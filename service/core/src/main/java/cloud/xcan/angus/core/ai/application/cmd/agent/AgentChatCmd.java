...
public interface AgentChatCmd {
   ...
   */
  AgentChatResult chat(Long agentId, String sessionId, String message, AgentChatConfig config);
   ...
   * @param config    可选配置覆盖
   */
  SseEmitter chatStream(Long agentId, String sessionId, String message, AgentChatConfig config);
