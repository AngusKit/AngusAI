...
import cloud.xcan.angus.core.ai.interfaces.setting.facade.SettingsFacade;
...
import cloud.xcan.angus.core.ai.interfaces.setting.facade.internal.assembler.SettingsAssembler;
...
public class SettingsFacadeImpl implements SettingsFacade {
  ...
  public UserSettingsVo updateUserSettings(Long userId, UserSettingsUpdateDto dto) {
    ...
    if (dto.getPreferences() != null && settings.getPreferences() != null) {
      cloud.xcan.angus.core.ai.domain.setting.UserPreferences prefs = settings.getPreferences();
    ...
    if (dto.getPrivacy() != null && settings.getPrivacy() != null) {
      cloud.xcan.angus.core.ai.domain.setting.PrivacySettings privacy = settings.getPrivacy();
