...
public interface ChatUsageLogRepo extends BaseRepository<ChatUsageLog, Long> {
   ...
   */
  @Query("""
      SELECT COUNT(l) FROM ChatUsageLog l WHERE l.requestTime BETWEEN :start AND :end""")
   ...
   */
  @Query("""
      SELECT COUNT(l) FROM ChatUsageLog l WHERE l.requestTime BETWEEN :start AND :end AND l.isSuccessful = true""")
   ...
   */
  @Query("""
      SELECT COUNT(l) FROM ChatUsageLog l WHERE l.appId = :appId AND l.requestTime BETWEEN :start AND :end""")
   ...
   */
  @Query("""
      SELECT COUNT(DISTINCT l.userId) FROM ChatUsageLog l WHERE l.requestTime BETWEEN :start AND :end""")
   ...
   */
  @Query("""
      SELECT SUM(l.totalTokens) FROM ChatUsageLog l WHERE l.requestTime BETWEEN :start AND :end""")
   ...
   */
  @Query("""
      SELECT AVG(l.responseTimeMs) FROM ChatUsageLog l WHERE l.requestTime BETWEEN :start AND :end""")
   ...
   */
  @Query("""
      SELECT l.modelId, COUNT(l), COALESCE(SUM(l.totalTokens), 0), COALESCE(SUM(l.cost), 0)
   ...
   */
  @Query("""
      SELECT l.endpoint, l.method, COUNT(l), AVG(l.responseTimeMs),
  ...
  @Query("""
      ...
      FROM ChatUsageLog l WHERE l.requestTime BETWEEN :start AND :end
      GROUP BY l.endpoint, l.method ORDER BY AVG(l.responseTimeMs) DESC""")
   ...
   */
  @Query("""
      SELECT l.statusCode, COUNT(l) FROM ChatUsageLog l
   ...
   */
  @Query("""
      SELECT l.userId, COUNT(l) FROM ChatUsageLog l
