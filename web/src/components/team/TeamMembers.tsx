...
export function TeamMembers() {
  ...
  const currentInvitations = pendingInvitations.slice(
    inviteStartIndex,
    inviteEndIndex
  );
  ...
  const handleChangeRole = (member: TeamMember, newRole: string) => {
    ...
    toast.success(
      `已将 ${member.name} 的角色更改为 ${getRoleBadge(newRole).label}`
    );
  };
                    ...
                    {currentMembers.map(member => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className='px-6 py-4'>
                            <Badge
                              className={`text-xs ${roleBadge.color} border-0 gap-1`}
                            >
                          ...
                          <td className='px-6 py-4'>
                            <Badge
                              className={`text-xs ${statusBadge.color} border-0 gap-1`}
                            >
                                ...
                                >
                                  {member.role !== 'owner' && (
                                    <>
                                      ...
                                      <DropdownMenuItem
                                        onClick={() =>
                                          handleChangeRole(member, 'viewer')
                                        }
                                        className='dark:text-gray-300'
                                      >
                ...
                <Pagination>
                  <PaginationContent>
                    <PaginationItem>
                      <PaginationPrevious
                        onClick={() =>
                          setCurrentInvitePage(prev => Math.max(1, prev - 1))
                        }
                        className={
                          currentInvitePage === 1
                            ? 'pointer-events-none opacity-50'
                    ...
                    <PaginationItem>
                      <PaginationNext
                        onClick={() =>
                          setCurrentInvitePage(prev =>
                            Math.min(totalInvitePages, prev + 1)
                          )
                        }
                        className={
            ...
            <div className='space-y-6'>
              ...
              <div className='grid grid-cols-2 gap-4'>
                <div className='space-y-1'>
                  ...
                  <Badge
                    className={`text-xs ${getRoleBadge(selectedMember.role).color} border-0`}
                  >
                ...
                <div className='space-y-1'>
                  ...
                  <Badge
                    className={`text-xs ${getStatusBadge(selectedMember.status).color} border-0`}
                  >
              ...
              <div className='grid grid-cols-2 gap-4'>
                <Card className='p-4 dark:bg-gray-900 dark:border-gray-700'>
                  ...
                  <div className='text-2xl dark:text-white'>
                    {selectedMember.resourcesShared}
                  </div>
                </Card>
                <Card className='p-4 dark:bg-gray-900 dark:border-gray-700'>
                  <div className='text-xs text-gray-500 dark:text-gray-400 mb-1'>
                  ...
                  <div className='text-2xl dark:text-white'>
                    {selectedMember.resourcesAccessed}
                  </div>
                </Card>
              </div>
            </div>
