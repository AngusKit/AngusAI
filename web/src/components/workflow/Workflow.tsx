...
export function Workflow() {
  ...
  const [infoDialogWorkflow, setInfoDialogWorkflow] =
  ...
  const filteredLogs = activityLogs.filter(log => {
    ...
    const matchesWorkflow =
      logWorkflowFilter === 'all' || log.workflowName === logWorkflowFilter;
  ...
  const uniqueWorkflowNames = Array.from(
    new Set(activityLogs.map(log => log.workflowName))
  );
                  ...
                  >
                    ...
                    <div className='flex items-start gap-3 mb-3'>
                      ...
                      <div className='flex-1'>
                        ...
                        <Badge
                          className={`text-xs ${workflow.statusColor} border-0`}
                        >
                          {workflow.status}
                        </Badge>
                      </div>
                ...
                <Pagination>
                  <PaginationContent>
                    <PaginationItem>
                      <PaginationPrevious
                        onClick={() =>
                          setWorkflowPage(prev => Math.max(1, prev - 1))
                        }
                        className={
                          workflowPage === 1
                    ...
                    <PaginationItem>
                      <PaginationNext
                        onClick={() =>
                          setWorkflowPage(prev =>
                            Math.min(totalWorkflowPages, prev + 1)
                          )
                        }
                        className={
                          workflowPage === totalWorkflowPages
                            ? 'pointer-events-none opacity-50'
                            : 'cursor-pointer'
                        }
                      />
                        ...
                        >
                          <td className='px-6 py-4'>
                            <div className='flex items-center gap-3'>
                              ...
                              >
                                <Icon
                                  className={`w-5 h-5 ${workflow.iconColor}`}
                                />
                              </div>
                              <div>
                ...
                {paginatedLogs.length > 0 ? (
                  paginatedLogs.map(log => (
                    ...
                    >
                      ...
                      <td className='px-6 py-4'>
                        <Badge
                          className={`text-xs ${log.statusColor} border-0`}
                        >
                          {log.status}
                        </Badge>
                      </td>
          ...
          <div className='flex justify-center'>
            <Pagination>
              <PaginationContent>
                ...
                {Array.from({ length: totalLogPages }, (_, i) => i + 1).map(
                  page => (
                    <PaginationItem key={page}>
                      <PaginationLink
