          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
              ...
              return (
                <Card 
                  key={workflow.id} 
                  className={`p-5 dark:bg-gray-800 dark:border-gray-700 hover:shadow-lg transition-all cursor-pointer ${
                ...
                >
                  ...
                  <div className="flex items-start gap-3 mb-3">
                    <div className={`${workflow.iconBg} w-12 h-12 rounded-lg flex items-center justify-center flex-shrink-0`}>
                      <Icon className={`w-6 h-6 ${workflow.iconColor}`} />
                    </div>
                    <div className="flex-1">
                      <h3 className="mb-1 dark:text-white">{workflow.name}</h3>
                      <Badge className={`text-xs ${workflow.statusColor} border-0`}>
                        {workflow.status}
                      </Badge>
                    </div>
                  </div>
                  ...
                  <PaginationContent>
                    ...
                    <PaginationItem>
                      <PaginationNext 
                        ...
                        className={workflowPage === totalWorkflowPages ? 'pointer-events-none opacity-50' : 'cursor-pointer'}
                      />
                    </PaginationItem>
                  </PaginationContent>
                </Pagination>
                    ...
                    return (
                      ...
                      >
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-3">
                            <div className={`${workflow.iconBg} w-10 h-10 rounded-lg flex items-center justify-center`}>
      ...
      <div>
        <div className="mb-4">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* Workflow Filter */}
            <Select value={logWorkflowFilter} onValueChange={(value) => {
              ...
              <SelectContent className="dark:bg-gray-800 dark:border-gray-700">
                <SelectItem value="all" className="dark:text-gray-300">全部工作流</SelectItem>
                ...
                {paginatedLogs.length > 0 ? (
                  paginatedLogs.map((log) => (
                    <tr key={log.id} className="hover:bg-gray-50 dark:hover:bg-gray-900">
                      ...
                      <td className="px-6 py-4">
                        <Badge className={`text-xs ${log.statusColor} border-0`}>
                          {log.status}
                        </Badge>
                      </td>
