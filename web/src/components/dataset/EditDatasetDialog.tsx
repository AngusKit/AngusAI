...
export function EditDatasetDialog({
  ...
  const [dataType, setDataType] = useState<'text' | 'table' | 'datasource'>(
    'table'
  );
      ...
      <div className='grid grid-cols-2 gap-8'>
        ...
        <div className='space-y-5'>
            ...
            <div className='space-y-2.5'>
              ...
              <div className='flex items-center gap-2'>
                <Checkbox
                  ...
                  checked={autoSegment}
                  onCheckedChange={checked =>
                    setAutoSegment(checked as boolean)
                  }
                />
                <label
              ...
              <div className='flex items-center gap-2'>
                <Checkbox
                  ...
                  onCheckedChange={checked =>
                    setNormalizeFormat(checked as boolean)
                  }
                />
                <label
          ...
          <div>
            ...
            <RadioGroup
              value={priority}
              onValueChange={value => setPriority(value as 'standard' | 'high')}
            >
