...
export function CreateApplication({ onBack }: { onBack: () => void }) {
  ...
  const [selectedTemplate, setSelectedTemplate] =
    useState<TemplateType>('modern-blue');
    ...
    switch (selectedType) {
      ...
      case 'knowledge':
        return {
          ...
          welcomeTemplate:
            '您好！我可以帮您查询知识库中的信息，请问有什么问题？',
        };
      case 'agent':
        return {
          namePrefix: 'Agent 任务代理',
          descriptionTemplate:
            '这是一个智能任务执行代理，支持多步推理和复杂任务处理，可以自动完成各种工作流程。',
          welcomeTemplate:
            '您好！我是智能任务代理，可以帮您执行各种任务，请告诉我需要做什么。',
        };
      default:
        return {
          namePrefix: '',
      ...
      <div className='animate-in fade-in duration-500'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto'>
          ...
          <div className='space-y-6'>
                ...
                {templates.map(template => (
                  ...
                  >
                    ...
                    <div className='flex gap-2 mt-3'>
                      <div
                        className={`w-8 h-8 ${template.primaryColor} rounded`}
                      ></div>
                      <div
            ...
            <Card
              className={`p-6 ${selectedTemplateObj?.secondaryColor} border-2 ${selectedTemplateObj?.accentColor}`}
            >
              ...
              <div className='bg-white dark:bg-gray-900 rounded-lg shadow-lg overflow-hidden'>
                {/* 聊天头部 */}
                <div
                  className={`${selectedTemplateObj?.primaryColor} p-4 flex items-center gap-3`}
                >
                ...
                <div className='p-4 space-y-3 h-64 overflow-y-auto'>
                  ...
                  <div className='flex gap-2 justify-end'>
                    <div
                      className={`${selectedTemplateObj?.primaryColor} p-3 rounded-lg rounded-tr-none max-w-[80%]`}
                    >
                ...
                {/* 输入框 */}
                <div
                  className={`p-3 border-t ${selectedTemplateObj?.accentColor}`}
                >
                  <div className='flex gap-2'>
                    <input
                      type='text'
                    ...
                    />
                    <button
                      className={`${selectedTemplateObj?.primaryColor} p-2 rounded-lg`}
                    >
                    ...
                    .map(kb => (
                      ...
                      >
                        <div className='flex items-start gap-3'>
                          ...
                          <div className='flex-1 min-w-0'>
                            <div className='flex items-center justify-between gap-2 mb-1'>
                              <h4 className='dark:text-white truncate'>
                                {kb.name}
                              </h4>
                              {selectedKnowledgeBase === kb.id && (
                ...
                <div>
                  ...
                  <div className='p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800'>
                    ...
                    <div className='flex items-center justify-between'>
                      ...
                      <span className='text-sm dark:text-white'>
                        {selectedModelObj?.contextTokens}
                      </span>
                    </div>
                  </div>
                </div>
                  ...
                  <div className='space-y-3 pr-4'>
                    ...
                    {testMessages.map((msg, index) => (
                      ...
                      >
                        ...
                        >
                          <p
                            className={`text-sm ${msg.role === 'assistant' ? 'dark:text-white' : 'text-white'}`}
                          >
                            {msg.content}
                          </p>
                        </div>
