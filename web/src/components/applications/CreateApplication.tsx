...
export function CreateApplication({ onBack }: { onBack: () => void }) {
  ...
  const steps = [
    ...
    { number: 4, title: '关联资源', description: '选择知识库、数据集、工作流' },
  ...
  const renderStep1 = () => (
    <div className="animate-in fade-in duration-500">
      <div className="text-center mb-8">
        <h2 className="text-3xl mb-2 dark:text-white">选择应用类型</h2>
  ...
  const renderStep2 = () => (
    <div className="animate-in fade-in duration-500">
      <div className="text-center mb-8">
        <h2 className="text-3xl mb-2 dark:text-white">配置 AI 模型</h2>
        <p className="text-gray-600 dark:text-gray-400">
  ...
  const renderStep4 = () => {
    ...
    return (
      <div className="animate-in fade-in duration-500">
        <div className="text-center mb-8">
          <h2 className="text-3xl mb-2 dark:text-white">关联资源</h2>
          <p className="text-gray-600 dark:text-gray-400">
            为应用关联知识库、数据集和工作流，提升AI能力（可选）
          </p>
        </div>
        ...
        {/* 提示信息 */}
        {(selectedKnowledgeBase || selectedDataset || selectedWorkflow) && (
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm dark:text-white mb-1">
                    ...
                    {selectedKnowledgeBase && (selectedDataset || selectedWorkflow) && '、'}
                    {selectedDataset && ' 数据集'}
                    {selectedDataset && selectedWorkflow && '、'}
                    {selectedWorkflow && ' 工作流'}
                  </p>
                  <p className="text-xs text-gray-600 dark:text-gray-400">
                    这些资源将帮助您的应用提供更准确、更专业的服务
                  </p>
                </div>
              </div>
            </Card>
  ...
  const renderStep5 = () => {
    ...
    return (
      <div className="animate-in fade-in duration-500">
        <div className="text-center mb-8">
          <h2 className="text-3xl mb-2 dark:text-white">预览与测试</h2>
          <p className="text-gray-600 dark:text-gray-400">
            确认您的应用配置并进行实时测试
          </p>
        </div>
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl dark:text-white mb-2">创建新应用</h1>
          <p className="text-gray-600 dark:text-gray-400">
            跟随引导步骤，快速创建您的AI应用
          </p>
        </div>
