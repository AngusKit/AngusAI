...
export function MyApplications({
  ...
  const filteredApps = applications.filter(app => {
    ...
    if (activeTab === 'text-generation')
      return app.category === 'text-generation';
  ...
  const getCategoryCount = (category: string) => {
    ...
    if (category === 'text-generation')
      return applications.filter(app => app.category === 'text-generation')
        .length;
  ...
  return (
    <div className='space-y-6'>
      ...
      <div
        className={
          viewMode === 'grid'
            ? 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-2.5'
            : 'space-y-3 mt-2.5'
        }
      >
              ...
              >
                <div className='flex items-center gap-4'>
                  ...
                  <div className='flex items-center gap-4'>
                    ...
                    {/* 状态标签 */}
                    <Badge
                      className={`text-xs ${getStatusBadgeColor(app.status as AppStatus)}`}
                    >
                      {app.status}
                    </Badge>
                    ...
                    <div className='flex items-center gap-2'>
                      ...
                      >
                        <Star
                          className={`w-4 h-4 ${app.isStarred ? 'fill-current' : ''}`}
                        />
                      </button>
                      <DropdownMenu>
                        <DropdownMenuTrigger asChild>
