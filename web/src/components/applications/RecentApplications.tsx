      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-4'>
        {isLoading ? (
          ...
          applications.map(app => (
            <Card
              key={app.id}
              className='p-5 hover:shadow-lg transition-all group dark:bg-gray-800'
            >
              <div className='flex items-start justify-between mb-3'>
                <div className='flex items-center gap-3'>
                  <div
          ...
          <DialogHeader>
            <div className='flex items-start gap-4 mb-4'>
              {selectedApp && (
                <>
                  <div
                    className={`${selectedApp.iconBg} w-16 h-16 rounded-xl flex items-center justify-center`}
                  >
            ...
            <div className='space-y-6'>
              ...
              <div className='grid grid-cols-2 gap-4'>
                ...
                <div className='flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg'>
                  ...
                  <div>
                    <div className='text-xs text-gray-500 dark:text-gray-400'>
                      {t('recentApps.totalCalls')}
                    </div>
                    <div className='text-sm dark:text-gray-200'>
                      {selectedApp.totalCalls}
                    </div>
                  </div>
                </div>
                <div className='flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg'>
                  ...
                  <div>
                    <div className='text-xs text-gray-500 dark:text-gray-400'>
                      {t('recentApps.avgResponseTime')}
                    </div>
                    <div className='text-sm dark:text-gray-200'>
                      {selectedApp.avgResponseTime}
                    </div>
                  </div>
                </div>
                <div className='flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg'>
