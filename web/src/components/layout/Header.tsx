      ...
      <div className='flex items-center justify-between w-full'>
        ...
        <div className='flex items-center gap-4'>
            ...
            >
              ...
              <div className='max-h-[500px] overflow-y-auto'>
                ...
                {filteredSuggestions.map((category, categoryIndex) => (
                  <div
                    key={categoryIndex}
                    className='p-4 border-b dark:border-gray-700 last:border-b-0'
                  >
          ...
          <Popover open={notificationOpen} onOpenChange={setNotificationOpen}>
            ...
            <PopoverContent
              className='w-96 p-0 dark:bg-gray-800 dark:border-gray-700'
              align='end'
            >
              {/* Header */}
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align='end'>
              <DropdownMenuItem
                ...
                className={
                  theme === 'light' ? 'bg-blue-50 dark:bg-blue-900' : ''
                }
              >
              ...
              <DropdownMenuItem
                ...
                className={
                  theme === 'dark' ? 'bg-blue-50 dark:bg-blue-900' : ''
                }
              >
          ...
          <Popover open={userPopoverOpen} onOpenChange={setUserPopoverOpen}>
            ...
            <PopoverContent
              className='w-56 p-0 dark:bg-gray-800 dark:border-gray-700'
              align='end'
            >
              {/* Header */}
              <div className='p-4 border-b dark:border-gray-700'>
