                ...
                <div key={index} className='flex items-center justify-between'>
                  <div className='flex-1'>
                    <div className='flex justify-between items-center mb-1'>
                      ...
                      <span
                        className={`text-sm ${index === 0 ? 'text-green-600 dark:text-green-400' : index === 1 ? 'text-purple-600 dark:text-purple-400' : 'text-gray-600 dark:text-gray-400'}`}
                      >
                        {item.percentage}%
                      </span>
                    </div>
              ...
              {costAnalysis.slice(1).map((item, index) => (
                ...
                >
                  <div className='flex justify-between items-center mb-1'>
                    ...
                    <span
                      className={`dark:text-gray-200 ${index === 0 ? 'text-green-600 dark:text-green-400' : ''}`}
                    >
                      {item.value}
                    </span>
                  </div>
