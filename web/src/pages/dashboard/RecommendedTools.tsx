    ...
    <div>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
        {tools.map((tool, index) => (
          <Card
            key={index}
            className='p-5 hover:shadow-lg transition-all cursor-pointer group hover:border-blue-500 dark:bg-gray-800 dark:hover:border-blue-400'
          >
            <div className='flex items-center gap-3 mb-3'>
              <div
                className={`${tool.iconBg} w-12 h-12 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform`}
              >
