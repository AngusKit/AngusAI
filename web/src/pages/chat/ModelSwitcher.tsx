              ...
              >
                ...
                <div className='flex-1 min-w-0'>
                  ...
                  <div className='flex items-center gap-2 mb-1'>
                    ...
                    <span className='text-xs text-gray-500 dark:text-gray-400'>上下文 {model.contextLength}</span>
                  </div>
                  ...
                  <div className='flex items-center gap-3 text-xs'>
                    <div className='flex items-center gap-1'>
                      ...
                      <span className={getSpeedColor(model.speed)}>{getSpeedLabel(model.speed)}</span>
                    </div>
