...
export function WorkflowInfoPage() {
  ...
  const avgTimeStr = avgTime != null ? `${avgTime.toFixed(1)}秒` : '--';
        ...
        <Card className='p-6 dark:bg-gray-800 dark:border-gray-700'>
          ...
          <div className='grid grid-cols-2 md:grid-cols-3 gap-4 pl-6'>
            ...
            <div className='space-y-2'>
              ...
              <p className='text-sm text-gray-700 dark:text-gray-300'>
                {(detail as { modifiedDate?: string }).modifiedDate ?? detail.createdDate ?? '--'}
              </p>
            </div>
            <div className='space-y-2'>
              <div className='flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400'>
              ...
              <p className='text-sm text-gray-700 dark:text-gray-300'>{avgTimeStr}</p>
            </div>
          </div>
        </Card>
      </div>
