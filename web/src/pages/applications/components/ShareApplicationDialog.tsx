...
export function ShareApplicationDialog({ open, onOpenChange, application }: ShareApplicationDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className='max-w-3xl dark:bg-gray-800 dark:border-gray-700'>
        <DialogHeader>
          ...
          <DialogDescription className='dark:text-gray-400'>通过多种方式分享您的应用给其他人</DialogDescription>
        </DialogHeader>
        ...
        <Tabs defaultValue='link' className='mt-4'>
          <TabsList className='grid w-full grid-cols-3 dark:bg-gray-900'>
            <TabsTrigger value='link' className='dark:data-[state=active]:bg-gray-700 dark:text-gray-300'>
              <Link2 className='w-4 h-4 mr-2' />
              分享链接
            </TabsTrigger>
            <TabsTrigger value='embed' className='dark:data-[state=active]:bg-gray-700 dark:text-gray-300'>
              <Globe className='w-4 h-4 mr-2' />
              嵌入网页
            </TabsTrigger>
            <TabsTrigger value='settings' className='dark:data-[state=active]:bg-gray-700 dark:text-gray-300'>
          ...
          <TabsContent value='link' className='space-y-4 mt-6'>
            <div className='space-y-2'>
              ...
              <div className='flex gap-2'>
                ...
                />
                <Button onClick={handleCopyLink} disabled={!canShare} className='shrink-0'>
            ...
            <div className='p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg'>
              <div className='flex items-start gap-3'>
                ...
                <div>
                  <p className='text-sm text-blue-800 dark:text-blue-200'>任何拥有此链接的人都可以访问您的应用</p>
          ...
          <TabsContent value='embed' className='space-y-4 mt-6'>
            <div className='space-y-2'>
              ...
              <div className='relative'>
                ...
                />
                <Button size='sm' onClick={handleCopyEmbedCode} disabled={!canShare} className='absolute top-2 right-2'>
            ...
            <div className='space-y-3'>
              ...
              <div className='border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-8 bg-gray-50 dark:bg-gray-900'>
                <div className='bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 max-w-md mx-auto'>
                  ...
                  <div className='text-sm text-gray-600 dark:text-gray-400'>{application.description}</div>
                </div>
              </div>
            </div>
            ...
            <div className='p-4 bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg'>
              <div className='flex items-start gap-3'>
                ...
                <div>
                  <p className='text-sm text-purple-800 dark:text-purple-200'>将此代码复制到您的网站中，即可嵌入应用</p>
            ...
            <div className='space-y-4'>
              <div className='flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-900 rounded-lg'>
                <div className='flex-1'>
                  ...
                  <p className='text-xs text-gray-500 dark:text-gray-400 mt-1'>允许任何人通过链接访问应用</p>
                </div>
                <Switch checked={isPublic} onCheckedChange={setIsPublic} disabled={!canShare} />
              </div>

              <div className='flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-900 rounded-lg'>
                <div className='flex-1'>
                  <Label className='text-sm dark:text-white'>匿名访问</Label>
                  <p className='text-xs text-gray-500 dark:text-gray-400 mt-1'>允许未登录用户使用应用</p>
                </div>
                <Switch
              ...
              <div className='flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-900 rounded-lg'>
                <div className='flex-1'>
                  ...
                  <p className='text-xs text-gray-500 dark:text-gray-400 mt-1'>访问前需要通过您的授权</p>
                </div>
                <Switch checked={requireAuth} onCheckedChange={setRequireAuth} disabled={!canShare || !isPublic} />
              </div>
            </div>
            ...
            <div className='p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg'>
              <div className='flex items-start gap-3'>
                ...
                <div>
                  ...
                  <p className='text-xs text-green-700 dark:text-green-300 mt-1'>您可以随时更改这些设置</p>
                </div>
              </div>
            </div>
          </TabsContent>
