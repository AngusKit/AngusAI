...
// 工作流类型
const workflowTypes = [
  { value: 'single-task', label: '单轮任务流', description: '执行单次任务的工作流，不保留上下文' },
  { value: 'multi-conversation', label: '多轮对话流（记忆）', description: '支持多轮对话并保留上下文记忆的工作流' },
];
          ...
          {selectedWorkflowType && (
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3">
              <p className="text-sm text-blue-800 dark:text-blue-300">
                <span className="font-semibold">{selectedWorkflowType.label}：</span>{selectedWorkflowType.description}
              </p>
            </div>
          )}
