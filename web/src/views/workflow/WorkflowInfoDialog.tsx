          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4 pl-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="name" className="dark:text-gray-300">工作流名称</Label>
                {mode === 'edit' ? (
                  <Input
                    id="name"
                    value={formData.name}
              ...
              {/* 工作流类型 */}
              <div className="space-y-2">
                <Label htmlFor="type" className="dark:text-gray-300">工作流类型</Label>
                {mode === 'edit' ? (
                  <Select value={formData.type} onValueChange={(value) => setFormData({ ...formData, type: value })}>
                    ...
                    <SelectContent className="dark:bg-gray-800 dark:border-gray-700">
                      <SelectItem value="single-task" className="dark:text-gray-300">单轮任务流</SelectItem>
                      <SelectItem value="multi-conversation" className="dark:text-gray-300">多轮对话流（记忆）</SelectItem>
                    </SelectContent>
                  </Select>
                ) : (
              ...
              {/* 描述 */}
              <div className="space-y-2">
                <Label htmlFor="description" className="dark:text-gray-300">描述</Label>
                {mode === 'edit' ? (
                  <Textarea
                    id="description"
