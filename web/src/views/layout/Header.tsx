  ...
  const searchSuggestions = [
    {
      category: '应用',
      items: [
        { name: '客服助手', description: 'AI智能客服对话系统', type: 'app', badge: '热门' },
        { name: '内容生成器', description: '自动生成营销文案', type: 'app', badge: null },
        { name: '数据分析助手', description: '智能数据分析与可视化', type: 'app', badge: '新' },
      ],
    },
    {
      category: '工作流',
      items: [
        { name: 'API 自动化集成', description: '连接多个API服务', type: 'workflow', badge: null },
        { name: '文档处理流程', description: '自动化文档解析和处理', type: 'workflow', badge: null },
      ],
    },
    {
      category: '知识库',
      items: [
        { name: '产品知识库', description: '产品相关文档和资料', type: 'knowledge', badge: null },
        { name: '技术文档库', description: 'API和开发文档', type: 'knowledge', badge: null },
      ],
    },
  ];
            ...
            >
              ...
              <div className="p-3 border-t dark:border-gray-700 bg-gray-50 dark:bg-gray-750">
                <div className="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400">
                  <div className="flex items-center gap-4">
                    <span>按 <kbd className="px-1.5 py-0.5 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded text-xs">↑</kbd> <kbd className="px-1.5 py-0.5 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded text-xs">↓</kbd> 导航</span>
                    <span>按 <kbd className="px-1.5 py-0.5 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded text-xs">Enter</kbd> 选择</span>
                  </div>
                  <span>按 <kbd className="px-1.5 py-0.5 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded text-xs">ESC</kbd> 关闭</span>
                </div>
              </div>
            </PopoverContent>
          </Popover>
