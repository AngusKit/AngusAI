...
export function MyApplications({ onCreateNew, onNavigate }: { onCreateNew?: () => void; onNavigate?: (page: string) => void }) {
  const { t } = useLanguage();
  ...
  const [applications, setApplications] = useState<Application[]>([
    ...
    },
    {
      ...
      tags: [
        ...
        { label: '开发工具', color: 'bg-teal-100 text-teal-700 dark:bg-teal-900/30 dark:text-teal-400' }
      ],
      visits: '1.1K 次调用',
      category: 'other',
    },
    {
      ...
      isStarred: false,
      tags: [
        { label: '营销', color: 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400' }
      ],
      visits: '',
      category: 'text-generation',
    },
    {
      ...
      isStarred: true,
      tags: [
        { label: '图像生成', color: 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400' }
      ],
      visits: '4.2K 次调用',
      category: 'other',
    },
    {
      ...
      isStarred: false,
      tags: [
        { label: '文本分析', color: 'bg-teal-100 text-teal-700 dark:bg-teal-900/30 dark:text-teal-400' }
      ],
      visits: '1.8K 次调用',
      category: 'knowledge',
    },
    ...
    },
    {
      ...
      isStarred: false,
      tags: [
        { label: '视频处理', color: 'bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-400' }
      ],
      visits: '682 次调用',
      category: 'other',
    },
    ...
    },
    {
      ...
      isStarred: false,
      tags: [
        { label: '电商', color: 'bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-400' }
      ],
      visits: '3.6K 次调用',
      category: 'text-generation',
    },
  ...
  const handleSaveEdit = (updatedData: Partial<Application>) => {
    ...
    setApplications(prev =>
      prev.map(app =>
        app.id === selectedApp.id ? { ...app, ...updatedData } : app
      )
    );
  };
