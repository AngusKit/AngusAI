...
export function TeamSettings() {
  ...
  const stats = [
    ...
    { label: '存储空间', value: '24.5 GB', subtext: '/ 100 GB', icon: Settings, color: 'text-orange-600' },
    { label: '安全评分', value: '92', subtext: '/ 100', icon: Shield, color: 'text-purple-600' }
  ];
