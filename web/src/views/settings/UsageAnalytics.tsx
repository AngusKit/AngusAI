...
export function UsageAnalytics() {
  ...
  const topEndpoints = [
    { endpoint: '/v1/chat/completions', calls: 12453, avgTime: '1.2s', successRate: '98.5%' },
    { endpoint: '/v1/embeddings', calls: 8921, avgTime: '0.8s', successRate: '99.2%' },
    { endpoint: '/v1/images/generations', calls: 3456, avgTime: '3.5s', successRate: '97.8%' },
    { endpoint: '/v1/audio/transcriptions', calls: 760, avgTime: '2.1s', successRate: '98.9%' }
  ];
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="api-calls" className="space-y-6">
        <TabsList className="grid w-full grid-cols-3 h-auto p-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
          <TabsTrigger value="api-calls" className="data-[state=active]:bg-blue-50 dark:data-[state=active]:bg-blue-900/30">
            API调用趋势
          </TabsTrigger>
          <TabsTrigger value="tokens" className="data-[state=active]:bg-blue-50 dark:data-[state=active]:bg-blue-900/30">
            令牌使用
          </TabsTrigger>
          <TabsTrigger value="performance" className="data-[state=active]:bg-blue-50 dark:data-[state=active]:bg-blue-900/30">
            性能分析
          </TabsTrigger>
        </TabsList>
