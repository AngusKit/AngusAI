...
CREATE FULLTEXT INDEX idx_ai_prompt_title_description_fulltext ON `ai_prompt` (`title`, `description`);
...
CREATE FULLTEXT INDEX idx_ai_prompt_category_name_fulltext ON `ai_prompt_category` (`name`);
...
CREATE FULLTEXT INDEX idx_api_collection_name_description_fulltext ON `api_collection` (`name`, `description`);
...
CREATE FULLTEXT INDEX idx_api_endpoint_name_description_fulltext ON `api_endpoint` (`name`, `description`);
...
CREATE FULLTEXT INDEX idx_api_key_name_fulltext ON `api_key` (`name`);
...
CREATE FULLTEXT INDEX idx_application_name_description_fulltext ON `application` (`name`, `description`);
...
CREATE FULLTEXT INDEX idx_chat_attachment_name_fulltext ON `chat_attachment` (`name`);
...
CREATE FULLTEXT INDEX idx_chat_session_title_fulltext ON `chat_session` (`title`);
...
CREATE FULLTEXT INDEX idx_dataset_name_description_fulltext ON `dataset` (`name`, `description`);
...
CREATE FULLTEXT INDEX idx_dataset_data_name_fulltext ON `dataset_data` (`name`);
...
CREATE FULLTEXT INDEX idx_knowledge_base_name_description_fulltext ON `knowledge_base` (`name`, `description`);
...
CREATE FULLTEXT INDEX idx_knowledge_base_document_name_fulltext ON `knowledge_base_document` (`name`);
...
CREATE FULLTEXT INDEX idx_model_name_description_fulltext ON `model` (`name`, `description`);
...
CREATE FULLTEXT INDEX idx_plugin_name_description_fulltext ON `plugin` (`name`, `description`);
...
CREATE FULLTEXT INDEX idx_resource_sharing_resource_name_fulltext ON `resource_sharing` (`resource_name`);
...
CREATE FULLTEXT INDEX idx_team_activity_resource_name_fulltext ON `team_activity` (`resource_name`);
...
CREATE FULLTEXT INDEX idx_team_settings_team_name_fulltext ON `team_settings` (`team_name`);
CREATE FULLTEXT INDEX idx_team_settings_team_description_fulltext ON `team_settings` (`team_description`);
...
CREATE FULLTEXT INDEX idx_vector_store_name_description_fulltext ON `vector_store` (`name`, `description`);
...
CREATE FULLTEXT INDEX idx_workflow_name_description_fulltext ON `workflow` (`name`, `description`);
